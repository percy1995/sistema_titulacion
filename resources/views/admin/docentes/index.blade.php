...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.docente.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Docente">
            <thead>
                <tr>
                    <th width="10">
...
@can('docente_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.docentes.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.docentes.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'dni', name: 'dni' },
{ data: 'direccion', name: 'direccion' },
{ data: 'correoinstitucional', name: 'correoinstitucional' },
{ data: 'correopersonal', name: 'correopersonal' },
{ data: 'celular', name: 'celular' },
{ data: 'tipo', name: 'tipo' },
{ data: 'firma', name: 'firma', sortable: false, searchable: false },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Docente').DataTable(dtOverrideGlobals);
